...
{{--                style="display:block; text-align:center;border-bottom:1px solid #ededed;margin-bottom:5px;">Advertisement</span>--}}
    ...
    <div class="container b_margin" style="margin-top: 0;">
        ...
        <div class="col-md-6">
            <div class="box">
                &nbsp; &nbsp;<a href="/ultimos-tonos-de-llamada" title="&Uacute;ltimos tonos de llamada">
                    <h2 class="title"><i class="fa fa-music" aria-hidden="true"></i> &Uacute;ltimos tonos de llamada
                    </h2>
                </a>
                <ul class="list_apps">
...
{{--                        <div class="developer"><i class="fa fa-eye" aria-hidden="true"></i> {{$song->listeners}}</div>--}}
        ...
        <div class="col-md-6">
            <div class="col-md-12">
                <div class="box">
                    &nbsp; &nbsp;<a href="/los-mejores-tonos-de-llamada" title="Mejores tonos de llamada ">
                        <h2 class="title"><i class="fa fa-music" aria-hidden="true"></i>Mejores tonos de llamada
                        </h2>
                    </a>
                    <ul class="list_apps">
