            ...
            <div class="col-md-8">
                <div class="box">
                    ...
                    <div class="title single-breadcrumb">
                        ...
                        <div class="post_breadcrumbs"><span><span><a style="color: #000000 !important;" href="{{route("webPageIndex")}}">Página de inicio</a> » <span><a href="/{{$category->category_slug}}" style="color: #000000 !important;" > {{$category->category_name}}</a> » <strong class="breadcrumb_last" aria-current="page">{{$song->title}}</strong></span></span></span></div>
                    </div>
                    <div class="post_container" style="background-color: white">
                        ...
                        <div class="post_content">
                            ...
                            <div class="post_head">
                                ...
                                <a id="btnModalx" href="/download/{{$song->id}}" class="btn_download" rel="nofollow" title="Download">Descargar<i class="fa fa-download"></i></a>
...
{{--                       <span style="display:block; text-align:center;border-bottom:1px solid #ededed;margin-bottom:5px;">Advertisement</span>--}}
                        ...
                        <div class="post_info">
                            ...
                            <ul id="ringtoneInfo">
                                <li>
                                    <label><i class="fa fa-eye" aria-hidden="true"></i> Puntos de vista</label>
                                    <span>{{$song->listeners}}</span>
                                </li>
                                <li>
                                    <label><i class="fa fa-calendar" aria-hidden="true"></i> Publicar</label>
                                    <span>{{$song->created_at}}</span>
                                </li>
                                <li>
                                    <label><i class="fa fa-file-audio-o" aria-hidden="true"></i> Talla</label>
                                    <span>{{$song->size}}</span>
                                </li>
                                <li>
                                    <label><i class="fa fa-download" aria-hidden="true"></i> Descargas</label>
                                    <span>{{$song->downloads}}</span>
                                </li>
                                <li>
                                    <label><i class="fa fa-list" aria-hidden="true"></i> Categorías</label>
                                    <span><a href="/{{$category->category_slug}}">{{$category->category_name}}</a> </span>
                                </li>
                            </ul>
                ...
                <div class="box column-3">
                    <h3 class="title">{{$category->category_name}} y Tonos de llamada similares</h3>
