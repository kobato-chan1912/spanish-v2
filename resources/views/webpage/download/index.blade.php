...
[
    "og_title" => "Descargar Pato Donald $category->category_name $song->title",
    "og_des" => "",
    "title" => "Descargar tono de llamada mp3 gratis"
])
                ...
                <div class="download-section">
                    <div id="download-ringtone" class="overlay">
                        <div class="title-download">
                            <h2>descargar {{$song->title}} Tonos de llamada</h2>
                        </div>


                        <div class="popup">
                            <p class="title-report">Descargar</p>
                                    ...
                                    <div class="bc-body wrap-box-mod">
                                        ...
                                        <div class="links">
                                            <div class="item item-obb">
                                                <span>MP3 File:</span>
                                                <a href="{{route("dlDownload"). "?id=" .$song->id}}" class="btn btn-green">Descargar mp3</a>
                                            </div>
                        ...
                        <div class="download-err">
                            <span>Si la descarga no comienza en unos segundos,</span> <a href="{{route("dlDownload"). "?id=" .$song->id}}">haga clic aquí!</a>
                        </div>
                    </div>
                </div>
